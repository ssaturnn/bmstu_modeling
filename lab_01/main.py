...
plt.plot(xs, ys[0], label='u0 euler', color="red")
plt.plot(xs, ys_pikar_2, label='u0 pikar_2', color="black")
plt.plot(xs, ys_pikar_1, label='u0 pikar_1', color="orange")
plt.plot(xs, ys_taylor, label='u0 taylor', color = "purple")
#print(f'{xs=}')
#print(f'{ys_taylor=}')
#for i in range(5):
